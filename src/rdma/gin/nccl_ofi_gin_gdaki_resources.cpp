...
void gdaki_endpoint::open(struct fid_domain *domain, struct fi_info *ref_info,
			  size_t cq_size, bool wide_wqe)
{
	endpoint.open(domain, ref_info, cq_size, wide_wqe);
	endpoint.enable();
}
			       ...
			       bool wide_wqe)
{
	...
	base.endpoint.open(domain, ref_info, ofi_nccl_cq_size(), wide_wqe);
			     ...
			     struct fi_efa_ops_gda *gda_ops)
{
	...
	base.endpoint.open(domain, ref_info, ofi_nccl_cq_size(), /* wide_wqe */ false);
